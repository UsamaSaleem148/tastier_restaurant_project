...
function filterMenuItems() {
    ...
    const allergens = document.getElementById('allergens').value.toLowerCase();
...
(_b = document.getElementById('vegan')) === null || _b === void 0 ? void 0 : _b.addEventListener('change', () => {
    document.getElementById('checkbox-vegan').classList.toggle('activeCheckBox');
    filterMenuItems();
});
(_c = document.getElementById('vegetarian')) === null || _c === void 0 ? void 0 : _c.addEventListener('change', () => {
